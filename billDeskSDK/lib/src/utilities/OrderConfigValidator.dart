...
class OrderConfigValidator {
  static void validateOrderConfig(SdkConfiguration sdkConfig) {
    ...
    if (flowType == FlowType.payments ||
        flowType == FlowType.payment_plus_mandate) {
      _isBlankOrNull(flowConfig?["bdOrderId"], "bdOrderId");
    } else if (flowType == FlowType.e_mandate ||
        flowType == FlowType.modify_mandate) {
  ...
  static SdkError getSdkError(String msg) {
    return SdkError(
        msg: msg, description: msg, SDK_ERROR: SdkError.SERVICE_ERROR);
  }
}
